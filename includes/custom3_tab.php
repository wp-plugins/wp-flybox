<?php
if (get_option('wpflybox_custom3_URL_instead')==='true'){echo '<a href="'.get_option('wpflybox_custom3_content').'">';}
if (get_option('wpflybox_my_custom3_tab')!='')
  {
  $wpflybox_custom3_tab_height=intval(get_option('wpflybox_my_custom3_tab_height'));
  $wpflybox_custom3_tab_width=intval(get_option('wpflybox_my_custom3_tab_width'));
  }else 
  {
  $wpflybox_custom3_tab_height=32;
  $wpflybox_custom3_tab_width=32;
  }
if (get_option('wpflybox_my_custom3_tab')=='')
  {
...
if ($wpflybox_side=='right')
  ...
  echo '<img src="'.plugins_url().'/wp-flybox/static/icons/custom/'.get_option('wpflybox_custom3_icon').'" style="width:28px;height:28px;padding:2px;" alt="?">';
  } else {
...
if (get_option('wpflybox_custom3_URL_instead')==='true'){echo '</a>';}
  ?>