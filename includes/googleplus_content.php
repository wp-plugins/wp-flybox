<div style="display:inline-block;border:1px solid <?php echo get_option('wpflybox_googleplus_border'); ?>;width:320px;background-color:<?php echo get_option('wpflybox_googleplus_background'); ?>;">
<?php
