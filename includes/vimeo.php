  ...
  <div style="padding:0px;border-top:1px solid #3cadc9;text-align:center;">
		<?php for($i=0; $i < $options['total']; $i++)	:?>
		  <?php if ($you['videos'][$i]['url']) { ?>
			<span class="wpfb_vimeo_vids" style="line-height:1;padding:5px 2px 5px 2px;width:48px;height:67px;display:inline-block;text-align:center;overflow:hidden;font-size:10px;">
