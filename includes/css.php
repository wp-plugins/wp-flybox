...
if($mobile_browser>0)
  {
  $wpfb_fbextramobile=-1*floor(get_option(wpflybox_facebook_scale)*$wpfb_fbwidth);
  }else {
...
if ($key=array_search('twitter',$wpflybox_tabs))
    {
    echo 'div.wpfb-twitter {width:'.($wpflybox_widths[2]+68).'px;height:241px;top:'.$wpflybox_pos[$key].';'.$wpflybox_side.':-'.($wpflybox_widths[2]+36).'px;position:'.$wpflybox_position.';z-index:999999;direction:ltr;}';
    echo 'div.wpfb-twitter div.wpfb-twitter-transition {width:'.($wpflybox_widths[2]+34+2).'px;'; if ($wpflybox_side=='left'){echo 'margin-left:32px;';} echo '-webkit-transition: margin-left 0.5s linear;-moz-transition: margin-left 0.5s linear;-o-transition: margin-left 0.5s linear;-ms-transition: margin-left 0.5s linear;transition: margin-left 0.5s linear;}';
...
if ($key=array_search('googleplus',$wpflybox_tabs))
    {
    echo 'div.wpfb-googleplus {width:'.($wpflybox_widths[3]+68).'px;top:'.$wpflybox_pos[$key].';'.$wpflybox_side.':-'.($wpflybox_widths[3]+36).'px;position:'.$wpflybox_position.';z-index:999999;direction:ltr;}';
    echo 'div.wpfb-googleplus div.wpfb-googleplus-transition {width:'.($wpflybox_widths[3]+34+2).'px;'; if ($wpflybox_side=='left'){echo 'margin-left:32px;';} echo '-webkit-transition: margin-left 0.5s linear;-moz-transition: margin-left 0.5s linear;-o-transition: margin-left 0.5s linear;-ms-transition: margin-left 0.5s linear;transition: margin-left 0.5s linear;}';
...
if ($key=array_search('youtube',$wpflybox_tabs))
    {        
    echo 'div.wpfb-youtube {width:'.($wpflybox_widths[4]+68).'px;height:110px;top:'.$wpflybox_pos[$key].';'.$wpflybox_side.':-'.($wpflybox_widths[4]+36).'px;position:'.$wpflybox_position.';z-index:999999;direction:ltr;}';
    echo 'div.wpfb-youtube div.wpfb-youtube-transition {width:'.($wpflybox_widths[4]+34).'px;'; if ($wpflybox_side=='left'){echo 'margin-left:32px;';} echo '-webkit-transition: margin-left 0.5s linear;-moz-transition: margin-left 0.5s linear;-o-transition: margin-left 0.5s linear;-ms-transition: margin-left 0.5s linear;transition: margin-left 0.5s linear;}';
...
if ($key=array_search('subscription',$wpflybox_tabs))
    {
    echo 'div.wpfb-subscribe {width:'.($wpflybox_widths[5]+68).'px;height:101px;top:'.$wpflybox_pos[$key].';'.$wpflybox_side.':-'.($wpflybox_widths[5]+36).'px;position:'.$wpflybox_position.';z-index:999999;direction:ltr;}';
    echo 'div.wpfb-subscribe div.wpfb-subscribe-transition {width:'.($wpflybox_widths[5]+34).'px;'; if ($wpflybox_side=='left'){echo 'margin-left:32px;';} echo '-webkit-transition: margin-left 0.5s linear;-moz-transition: margin-left 0.5s linear;-o-transition: margin-left 0.5s linear;-ms-transition: margin-left 0.5s linear;transition: margin-left 0.5s linear;}';
...
if ($key=array_search('pinterest',$wpflybox_tabs))
    {     
    echo 'div.wpfb-pinterest {width:'.($wpflybox_widths[6]+68).'px;height:101px;top:'.$wpflybox_pos[$key].';'.$wpflybox_side.':-'.($wpflybox_widths[6]+36).'px;position:'.$wpflybox_position.';z-index:999999;direction:ltr;}';
    echo 'div.wpfb-pinterest div.wpfb-pinterest-transition {width:'.($wpflybox_widths[6]+34).'px;'; if ($wpflybox_side=='left'){echo 'margin-left:32px;';} echo '-webkit-transition: margin-left 0.5s linear;-moz-transition: margin-left 0.5s linear;-o-transition: margin-left 0.5s linear;-ms-transition: margin-left 0.5s linear;transition: margin-left 0.5s linear;}';
...
if ($key=array_search('linkedin',$wpflybox_tabs))
    {         
    echo 'div.wpfb-linkedin {width:'.($wpflybox_widths[7]+68).'px;height:168px;top:'.$wpflybox_pos[$key].';'.$wpflybox_side.':-'.($wpflybox_widths[7]+36).'px;position:'.$wpflybox_position.';z-index:999999;direction:ltr;}';
    echo 'div.wpfb-linkedin div.wpfb-linkedin-transition {width:'.($wpflybox_widths[7]+34+2).'px;'; if ($wpflybox_side=='left'){echo 'margin-left:32px;';} echo '-webkit-transition: margin-left 0.5s linear;-moz-transition: margin-left 0.5s linear;-o-transition: margin-left 0.5s linear;-ms-transition: margin-left 0.5s linear;transition: margin-left 0.5s linear;}';
...
if ($key=array_search('contact',$wpflybox_tabs))
    {
    echo 'div.wpfb-contact {width:'.($wpflybox_widths[8]+68).'px;height:300px;top:'.$wpflybox_pos[$key].';'.$wpflybox_side.':-'.($wpflybox_widths[8]+36).'px;position:'.$wpflybox_position.';z-index:999999;direction:ltr;}';
    echo 'div.wpfb-contact div.wpfb-contact-transition {width:'.($wpflybox_widths[8]+34+2).'px;'; if ($wpflybox_side=='left'){echo 'margin-left:32px;';} echo '-webkit-transition: margin-left 0.5s linear;-moz-transition: margin-left 0.5s linear;-o-transition: margin-left 0.5s linear;-ms-transition: margin-left 0.5s linear;transition: margin-left 0.5s linear;}';
...
if ($key=array_search('flickr',$wpflybox_tabs))
    {
    echo 'div.wpfb-flickr {width:'.($wpflybox_widths[9]+68).'px;top:'.$wpflybox_pos[$key].';'.$wpflybox_side.':-'.($wpflybox_widths[9]+36).'px;position:'.$wpflybox_position.';z-index:999999;direction:ltr;}';
    echo 'div.wpfb-flickr div.wpfb-flickr-transition {width:'.($wpflybox_widths[9]+34).'px;'; if ($wpflybox_side=='left'){echo 'margin-left:32px;';} echo '-webkit-transition: margin-left 0.5s linear;-moz-transition: margin-left 0.5s linear;-o-transition: margin-left 0.5s linear;-ms-transition: margin-left 0.5s linear;transition: margin-left 0.5s linear;}';
...
if ($key=array_search('deviant',$wpflybox_tabs))
    {
    echo 'div.wpfb-deviant {width:'.($wpflybox_widths[10]+68).'px;top:'.$wpflybox_pos[$key].';'.$wpflybox_side.':-'.($wpflybox_widths[10]+36).'px;position:'.$wpflybox_position.';z-index:999999;direction:ltr;}';
    echo 'div.wpfb-deviant div.wpfb-deviant-transition {width:'.($wpflybox_widths[10]+34).'px;'; if ($wpflybox_side=='left'){echo 'margin-left:32px;';} echo '-webkit-transition: margin-left 0.5s linear;-moz-transition: margin-left 0.5s linear;-o-transition: margin-left 0.5s linear;-ms-transition: margin-left 0.5s linear;transition: margin-left 0.5s linear;}';
...
if ($key=array_search('vimeo',$wpflybox_tabs))
    ...
    echo 'div.wpfb-vimeo {width:'.($wpflybox_widths[12]+68).'px; top:'.$wpflybox_pos[$key].';'.$wpflybox_side.':-'.($wpflybox_widths[12]+36).'px;position:'.$wpflybox_position.';z-index:999999;direction:ltr;}';
    echo 'div.wpfb-vimeo div.wpfb-vimeo-transition {width:'.($wpflybox_widths[12]+34).'px;'; if ($wpflybox_side=='left'){echo 'margin-left:32px;';} echo '-webkit-transition: margin-left 0.5s linear;-moz-transition: margin-left 0.5s linear;-o-transition: margin-left 0.5s linear;-ms-transition: margin-left 0.5s linear;transition: margin-left 0.5s linear;}';
