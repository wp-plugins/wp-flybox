...
echo ':</b><br><form style="padding:5px;" action="'.plugins_url().'/wp-flybox/contact.php" method="post" target="popupwindow" onsubmit="window.open(\''.plugins_url().'/wp-flybox/contact.php\', \'popupwindow\', \'scrollbars=no,width=300,height=300\');return true">
