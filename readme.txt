...
Donate link: https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=C6BJ8C7NPJTVW
...
http://wordpress.org/plugins/wp-flybox/ I usually can respond within 24 hours.
= Is Javascript used? =
Yes, this plugin uses wordpresses preloaded jquery.
= Why won't this work with some themes? =
All themes have different layouts and properties that can affect the correct look of this plugin. If this is the case PLEASE let me know so I can fix it.
== Screenshots ==
...
== Changelog ==
= 6.6 =
* Added option to change twiter tab height.
= 6.5 =
* Added ability to make button link to a webpage instead of sliding out a box.
= 6.4 =
* Changed a couple url references to support HTTPS/SSL.
= 6.3 =
...
= 6.0 =
* Adjust the tabs on page ready and page load so the tabs are lined up to the edge if loading external content
* Updated for Wordpress 4.0
= 5.19 =
* Added uninstall cleanup
= 5.18 =
* Added shortcode processing to custom tabs.
= 5.17 =
* Fixed show on pages setting.
* Misc bug fix
= 5.16 =
* Added more custom tabs.
= 5.15 =
* Fixed IE not hovering all the way out.
* Added option to use flickr non flash version to help hover issue in IE
= 5.14 =
...
* Misc. Bugs
= 5.11 =
* Fixed G+ peeking onto the page and not hiding off page
= 5.10 =
* Instagram bug fix (not showing images)
= 5.9 =
* Bug Fix (redeclared mobile detect causing problem in some themes)
= 5.8 =
* Tiny bug fix
= 5.7 =
* Added option to use twitter bird logo instead of the "t"
= 5.6 =
* Added Tumblr tab.
= 5.5 =
...
* Fixed minor bugs.
= 5.3 =
* Fixed float and hover bug.
= 5.2 =
* Bug Fixes.
= 5.1 =
* Bug Fixes.
= 5.0 =
* Complete rewrite with many more options and better stability.
* Added Spanish language.
* Added custom tab.
* Added click to open option.
* Please re-save your settings after update.
* Please let me know of the bugs. Since I started from scratch there's bound to be a few.
= 4.3 =
* Updated to new Google+ badges with many more options.
* PLEASE update your Google+ settings after update!
= 4.2 =
* Instagram bug fix.
= 4.1 =
...
* Added backend support for languages.
= 3.15 =
* Added width setting for facebook tab.
= 3.14 =
* Scaled large facebook frame down on mobile devices to fit smaller screens.
= 3.13 =
* Twitter bug fixes.
= 3.12 =
* Twitter phased out their v1 API so had to update to new version.
= 3.11 =
* Bug fixes.
= 3.10 =
* Bug fixes.
= 3.9 =
* Fixed instagram issuses caused after only 1 failed instagram server request.
= 3.8 =
* Fixed bug causing tabs to not show up on some front pages that have a theme controlled front page.
= 3.7 =
* Fixed caching problem on some newer wordpress sites dealing with the Vimeo, Deviant, Instagram, and Twitter tabs.
= 3.6 =
* Fixed Delimeter bug and hide on page by ID bug. 
= 3.5 =
* Quick delimeter bug fix.
= 3.4 =
* Fixed issues with twitter tab.
* Added "Show latest tweet" option to twitter tab.
* Added option to show on specific pages
= 3.3 =
...
= 3.1.1 =
* Fixed Twitter bugs
* Gave alternate to Twitter tab if giving errors.
= 3.1 =
* New option to delete caches.
* Fully W3C valid now.
* Vimeo fixes.
* Instagram fixes.
= 3.0.1 =
...
* More descriptions on settings page.
= 1.1 =
...
* Fixed some iframes being hidden on some responsive enabled themes.
= 5.4 =
* 5.4:Fixed minor bugs.
* 5.0:Many changes and additions. See change log.
= 5.3 =
* 5.3:Fixed float and hover bug.
* 5.0:Many changes and additions. See change log.
= 5.2 =
* 5.2:Bug Fixes.
* 5.0:Many changes and additions. See change log.
...
= 3.10 =
* Bug fixes.
* Please clear the cached saves of instagram, twitter, vimeo, and deviant art using the option at the bottom of the settings and refreshing your website a couple times if needed.
= 3.9 =
* Fixed instagram issuses caused after only 1 failed instagram server request.
= 3.8 =
* Fixed bug causing tabs to not show up on some front pages that have a theme controlled front page.
...
* Added Instagram Tab.
* Many Bug fixes and enhancements.
* I have made several small changes to the code, please let me know if you run into problems.
= 1.8 =
* Fixed Feedburner Subscriptions saying email subscriptions not activated.
= 1.7 =
* Expanded hover area to resolve jittery effect.
