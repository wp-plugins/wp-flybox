...
while ($i <= $wpflybox_count)
    ...
    if ($wpflybox_tabs[$i]=="facebook")
        {
        echo 'div.wpfb-facebook {width: 337px;top:'.$wpflybox_pos[$i].';left:-306px;position:fixed;z-index:900;}';
        echo 'div.wpfb-facebook-transition table, th, tr, td{margin: 0;padding: 0;border: 0;outline: 0;font-size: 100%;background: transparent;}';
    ...
    if ($wpflybox_tabs[$i]=="twitter")
        {
        echo 'div.wpfb-twitter {width: 301px;top:'.$wpflybox_pos[$i].';left:-271px;position:fixed;z-index:900;}';
        echo 'div.wpfb-twitter-transition table, th, tr, td{margin: 0;padding: 0;border: 0;outline: 0;font-size: 100%;background: transparent;}';
    ...
    if ($wpflybox_tabs[$i]=="googleplus")
        {
        echo 'div.wpfb-googleplus {width: 339px;top:'.$wpflybox_pos[$i].';left:-306px;position:fixed;z-index:900;}';
        echo 'div.wpfb-googleplus-transition table, th, tr, td{margin: 0;padding: 0;border: 0;outline: 0;font-size: 100%;background: transparent;}';
        ...
        echo 'div.wpfb-googleplus:hover div.wpfb-googleplus-transition {margin-left: 336px;}'; 
        }
    if ($wpflybox_tabs[$i]=="youtube")
        {        
        echo 'div.wpfb-youtube {width: 339px;top:'.$wpflybox_pos[$i].';left:-306px;position:fixed;z-index:900;}';
        echo 'div.wpfb-youtube-transition table, th, tr, td{margin: 0;padding: 0;border: 0;outline: 0;font-size: 100%;background: transparent;}';
    ...
    if ($wpflybox_tabs[$i]=="subscription")
        {
        echo 'div.wpfb-subscribe {width: 339px;top:'.$wpflybox_pos[$i].';left:-296px;position:fixed;z-index:900;}';
        echo 'div.wpfb-subscribe-transition table, th, tr, td{margin: 0;padding: 0;border: 0;outline: 0;font-size: 100%;background: transparent;}';
    ...
    if ($wpflybox_tabs[$i]=="pinterest")
        {     
        echo 'div.wpfb-pinterest {width: 339px;top:'.$wpflybox_pos[$i].';left:-260px;position:fixed;z-index:900;}';
        echo 'div.wpfb-pinterest-transition table, th, tr, td{margin: 0;padding: 0;border: 0;outline: 0;font-size: 100%;background: transparent;}';
    ...
    if ($wpflybox_tabs[$i]=="linkedin")
        {         
        echo 'div.wpfb-linkedin {width: 403px;top:'.$wpflybox_pos[$i].';left:-370px;position:fixed;z-index:900;}';
        echo 'div.wpfb-linkedin-transition table, th, tr, td{margin: 0;padding: 0;border: 0;outline: 0;font-size: 100%;background: transparent;}';
...
while ($i <= $wpflybox_count)
    ...
    if ($wpflybox_tabs[$i]=="facebook")
        {
        echo 'div.wpfb-facebook {width: 270px;top:'.$wpflybox_pos[$i].';right:-237px;position:fixed;z-index:900;}';
        echo 'div.wpfb-facebook-transition table, th, tr, td{margin: 0;padding: 0;border: 0;outline: 0;font-size: 100%;background: transparent;}';
        ...
        echo 'div.wpfb-facebook div.wpfb-facebook-transition iframe {border:0px;overflow:hidden;position:static;height:260px;}';
        echo 'div.wpfb-facebook:hover div.wpfb-facebook-transition {margin-left: -337px;}';  
        }
    if ($wpflybox_tabs[$i]=="twitter")
        {
        echo 'div.wpfb-twitter {width: 270px;top:'.$wpflybox_pos[$i].';right:-237px;position:fixed;z-index:900;}';
        echo 'div.wpfb-twitter-transition table, th, tr, td{margin: 0;padding: 0;border: 0;outline: 0;font-size: 100%;background: transparent;}';
    ...
    if ($wpflybox_tabs[$i]=="googleplus")
        {
        echo 'div.wpfb-googleplus {width: 270px;top:'.$wpflybox_pos[$i].';right:-237px;position:fixed;z-index:900;}';
        echo 'div.wpfb-googleplus-transition table, th, tr, td{margin: 0;padding: 0;border: 0;outline: 0;font-size: 100%;background: transparent;}';
        ...
        echo 'div.wpfb-googleplus:hover div.wpfb-googleplus-transition {margin-left: -360px;}';
        echo 'div.wpfb-googleplus div.wpfb-googleplus-transition iframe {border:0px;overflow:hidden;position:static;}';
        }
    if ($wpflybox_tabs[$i]=="youtube")
        {        
        echo 'div.wpfb-youtube {width: 270px;top:'.$wpflybox_pos[$i].';right:-237px;position:fixed;z-index:900;}';
        echo 'div.wpfb-youtube-transition table, th, tr, td{margin: 0;padding: 0;border: 0;outline: 0;font-size: 100%;background: transparent;}';
    ...
    if ($wpflybox_tabs[$i]=="subscription")
        {
        echo 'div.wpfb-subscribe {width: 270px;top:'.$wpflybox_pos[$i].';right:-237px;position:fixed;z-index:900;}';
        echo 'div.wpfb-subscribe-transition table, th, tr, td{margin: 0;padding: 0;border: 0;outline: 0;font-size: 100%;background: transparent;}';
    ...
    if ($wpflybox_tabs[$i]=="pinterest")
        {     
        echo 'div.wpfb-pinterest {width: 270px;top:'.$wpflybox_pos[$i].';right:-237px;position:fixed;z-index:900;}';
        echo 'div.wpfb-pinterest-transition table, th, tr, td{margin: 0;padding: 0;border: 0;outline: 0;font-size: 100%;background: transparent;}';
        ...
        echo 'div.wpfb-pinterest:hover div.wpfb-pinterest-transition {margin-left: -288px;}';
        }
    if ($wpflybox_tabs[$i]=="linkedin")
        {         
        echo 'div.wpfb-linkedin {width: 396px;top:'.$wpflybox_pos[$i].';right:-363px;position:fixed;z-index:900;}';
        echo 'div.wpfb-linkedin-transition table, th, tr, td{margin: 0;padding: 0;border: 0;outline: 0;font-size: 100%;background: transparent;}';
...
while ($i <= $wpflybox_count)
    ...
    if ($wpflybox_tabs[$i]=="pinterest")
        {
        ?>
        <div class="wpfb-pinterest"><div class="wpfb-pinterest-transition"><table><tr><th valign="top"><div style="margin-right:-3px; margin-top:-1px; width:32px; height:101px; background-position:0px -101px; background-image:url('<?php echo $wpflybox_sprite_url; ?>')"> </div></th><th style="background-color:#fff; border: 2px solid #5b5b5b;">
        <div align="center"><a href="http://pinterest.com/<?php echo $wpflybox_pinterest; ?>"><img src="http://twitterbuttons.sociableblog.com/images/pinterest-button5.png" title="Pinterest" width="250" height="60" border="0" /></a></div>
        </th></tr></table></div></div>
        <?php
        }    
    if ($wpflybox_tabs[$i]=="linkedin")
        {
        ?>
        <div class="wpfb-linkedin"><div class="wpfb-linkedin-transition"><table><tr><th valign="top"><div style="margin-right:-3px; margin-top:-1px; width:32px; height:101px; background-position:0px -505px; background-image:url('<?php echo $wpflybox_sprite_url; ?>')"> </div></th><th style="background-color:#fff; border: 2px solid #4875B4;">
        <script src="//platform.linkedin.com/in.js" type="text/javascript"></script>
        <script type="IN/MemberProfile" data-id="<?php echo $wpflybox_linkedin; ?>" data-format="inline" data-related="false" data-width="364"></script>
        </th></tr></table></div></div>
        <?php
